...
<body>
	<div class="container">
		<div class="cadastro-box">
			...
			<form id="cadastroForm" action="processa_empresa.php" method="POST">
				<div class="input-group">
					<label for="empresaNome">Nome da Empresa</label>
					<input type="text" id="empresaNome" name="razao_social" required>
				</div>
				<div class="input-group">
					<label for="enquadramento">Enquadramento Fiscal</label>
					<input type="text" id="tipoEmpresa" name="enquadramento" placeholder="Selecione o tipo de empresa" required>
					<ul class="listaTiposEmpresas" id="listaTiposEmpresas">
						<li id="simplesNacional">Simples Nacional</li>
						<li id="mei">MEI</li>
						<li id="normal">Normal</li>
						<li id="caepf">CAEPF</li>
					</ul>
				</div>
				<div class="input-group">
			...
			<a href="panel.php" class="back-button">Voltar</a>
		</div>
	</div>
